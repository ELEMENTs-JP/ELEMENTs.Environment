...
namespace ELEMENTS.Infrastructure
{
    ...
    {
        /// <summary>
        /// Gibt die Bezeichnung des Produktes zurück
        /// Returns the title of the product
        /// </summary>
        public string Title { get; set; }

        /// <summary>
        /// Gibt das Label des Produktes zurück
        /// Returns the maturity level of the product
        /// </summary>
        public string Label { get; set; }

        /// <summary>
        /// Gibt die ID des Herstellers des Produktes zurück
        /// Returns the business id of the constructor of the product
        /// </summary>
        public string ID { get; set; }
        
        /// <summary>
        /// Gibt die technische Versionsnummer des Produktes zurück
        /// Returns the technical version number of the product
        /// </summary>
