...
export function loadVerticalBarChart(divID, dotNetHelper)
{
    // Create Parameter 
    let jsonParameter = {
        "DIV": divID,
    ...
    try {
        ...
        dotNetHelper.invokeMethodAsync('LoadChartData', jsonParameter).then(data => {
            ...
            onBarVerticalChartJSSucess(data)
        });

        // Assembly Name + Method 
        //DotNet.invokeMethodAsync('STRIDES.BarVerticalChart', 'LoadBarVerticalChart', jsonParameter).then(data => {
...
function onBarVerticalChartJSSucess(data) {
