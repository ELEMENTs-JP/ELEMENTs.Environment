...
{
    public partial class DoughnutChart : IAsyncDisposable, IDisposable
    {
        // Fields 
        ...
        public void Init(IJSRuntime jsRuntime)
        {
            try
            {
                ...
                moduleTask = new(() => jsRuntime.InvokeAsync<IJSObjectReference>(
                   "import", "./_content/ELEMENTS.Controls/donutchart.js").AsTask());
        ...
        public async ValueTask LoadChart(string divID)
        {
            try
            {
                ...
                await module.InvokeVoidAsync("loadDonutChart", divID, objRef);
